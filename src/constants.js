...
export const MMHG_TO_MILLIBARS = EARTH_SURF_PRES_IN_MILLIBARS / EARTH_SURF_PRES_IN_MMHG;
export const PSI_TO_MILLIBARS = EARTH_SURF_PRES_IN_MILLIBARS / EARTH_SURF_PRES_IN_PSI;
export const H20_ASSUMED_PRESSURE = 47.0 * MMHG_TO_MILLIBARS; /* Dole p. 15      */
...
export const MAX_HABITABLE_PRESSURE = 118 * PSI_TO_MILLIBARS; /* Dole, p. 16    */
...
export const EARTH_AVERAGE_KELVIN = EARTH_AVERAGE_CELSIUS + FREEZING_POINT_OF_WATER;
...
export const GREENHOUSE_TRIGGER_ALBEDO = 0.20;
...
export const MILLIBARS_PER_BAR = 1000.00;
